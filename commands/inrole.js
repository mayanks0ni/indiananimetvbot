...
module.exports.run = async (bot, message, args) => {
    ...
    if (!rolename) return message.channel.send(new Discord.MessageEmbed().setTitle('This Command Is Used Like This \`+inrole [rolename]\`').setColor(0xff0000).setFooter(message.guild.me.displayName).setTimestamp());
